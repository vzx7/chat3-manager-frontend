        ...
        <div>
          ...
          <ul className="mb-6 flex flex-col gap-1.5">
            ...
            {currentUser?.role === Role.admin ?
              <SidebarLinkGroup
                activeCondition={
                  pathname === 'managers' || pathname.includes('dashboard')
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${(pathname === 'managers' ||
                            pathname.includes('dashboard')) &&
                          'bg-graydark dark:bg-meta-4'
                          }`}
                        onClick={(e) => {
